...
public class Test {
	...
	/*
	 * @org.junit.Test public void test() { // Tell Java to use your special
	 * stream System.setOut(MyPrintStream);
	 * 
	 * // Print some output: goes to your special stream
	 * ex_object.printNumbers();
	 * 
	 * // Put things back System.out.flush(); System.setOut(old);
	 * 
	 * // Show what happened // System.out.println("Here: " +
	 * outContent.toString());
	 * 
	 * // Get result from stream in form of string String str_res =
	 * outContent.toString();
	 * 
	 * // Split the string by line String[] res = str_res.split("\\r?\\n");
	 * 
	 * // Assert Cases: assertEquals("1", res[0]); // 1 is not multiple of 3 or
	 * 5 assertEquals("2", res[1]); // 2 is not multiple of 3 or 5
	 * assertEquals("Fizz", res[2]); // 3 is multiple of 3 assertEquals("4",
	 * res[3]); // 4 is not multiple of 3 or 5 assertEquals("FizzBuzz",
	 * res[29]); // 30 is multiple of 3 and 5 -> // FizzBuzz
	...
	*/
	...
	public void testFindPattern() {
		assertEquals(true, ex_object.findPattern("Hello world", "ello"));
		assertEquals(false, ex_object.findPattern("xxxyyyy", "ello"));
		assertEquals (true, ex_object.findPattern("Helloelllo", "llo"));
	}
